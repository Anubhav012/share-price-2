...
@Component({
  selector: 'app-top-gainer-table-format',
  templateUrl: './top-gainer-table-format.component.html',
  styleUrls: ['./top-gainer-table-format.component.css']
})
export class TopGainerTableFormatComponent implements OnInit {
